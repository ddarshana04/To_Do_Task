...
function addTask(e) {
  ...
  let description = document.querySelector(".form_desc").value;
  ...
  for (let i = 0; i < tasks.length; i++) {
    ...
    if (title == title_c) {
      if(completed == 1) {
        ...
        <div class="todo_task_desc">
            <p class="task_desc">
            `+description+`
            </p>
            <article class="task_deadline">Due date : `+deadline+` </article>
        </div>
        </div>
        `;
      }
...
function displayTask() {
  ...
  number.innerHTML = "No of Pending Tasks = " + live + ", No of Completed Tasks = " + com;
  display.innerHTML = "";
